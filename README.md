# ROBUSTTHREED ART-MODEL GENERATOR · 5 MILLION
...
GitHub displays the actual live address after a successful deployment. The expected project address is `https://vedamrit01.github.io/ROBUSTTHREED_ART-MODEL_GENERATOR_5MILLION/`.
...
Artwork, previews, and generated STL files stay in the visitor's browser tab. No database, API key, paid conversion API, or server-side artwork upload is required. GitHub serves the application assets.
